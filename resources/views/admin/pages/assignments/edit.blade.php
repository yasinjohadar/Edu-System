    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">تعديل واجب</h5>
                </div>
            </div>
                            ...
                            <form action="{{ route('admin.assignments.update', $assignment->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="section_id" class="form-select">
                                            ...
                                            @foreach($sections as $section)
                                                <option value="{{ $section->id }}" {{ old('section_id', $assignment->section_id) == $section->id ? 'selected' : '' }}>{{ $section->name }} - {{ $section->class->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('section_id')
                                            <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" name="total_marks" class="form-control" step="0.01" min="1" value="{{ old('total_marks', $assignment->total_marks) }}" required>
                                        @error('total_marks')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="time" name="due_time" class="form-control" value="{{ old('due_time', $assignment->due_time) }}" required>
                                        @error('due_time')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="allow_late_submission" value="1" {{ old('allow_late_submission', $assignment->allow_late_submission) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="late_penalty_per_day" class="form-control" step="0.01" min="0" value="{{ old('late_penalty_per_day', $assignment->late_penalty_per_day) }}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="max_late_days" class="form-control" min="1" value="{{ old('max_late_days', $assignment->max_late_days) }}">
                                        @error('max_late_days')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="max_attempts" class="form-control" min="1" max="10" value="{{ old('max_attempts', $assignment->max_attempts) }}" placeholder="اتركه فارغاً لغير محدود">
                                        @error('max_attempts')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="allow_resubmission" value="1" {{ old('allow_resubmission', $assignment->allow_resubmission) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" name="resubmission_deadline" class="form-control" value="{{ old('resubmission_deadline', $assignment->resubmission_deadline?->format('Y-m-d')) }}">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        @php
                                            $submissionTypes = is_string($assignment->submission_types) ? json_decode($assignment->submission_types, true) : ($assignment->submission_types ?? ['file', 'text', 'link']);
                                            $oldTypes = old('submission_types', $submissionTypes);
                                        @endphp
                                        <div class="d-flex gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="submission_types[]" value="file" id="type_file" {{ in_array('file', $oldTypes) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="type_file">ملفات</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="submission_types[]" value="text" id="type_text" {{ in_array('text', $oldTypes) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="type_text">نصوص</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="submission_types[]" value="link" id="type_link" {{ in_array('link', $oldTypes) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check mt-4">
                                            <input class="form-check-input" type="checkbox" name="is_active" value="1" {{ old('is_active', $assignment->is_active) ? 'checked' : '' }}>
                                            ...
                                            @foreach($assignment->attachments as $attachment)
                                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label text-danger" for="delete_{{ $attachment->id }}">حذف</label>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
