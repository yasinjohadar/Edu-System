        ...
        <div class="container-fluid">
            ...
            <div class="admin-page-header">
                <div class="page-title-wrap">
                    <h1>تعديل الجدول الدراسي</h1>
                    <p>تحديث بيانات الحصة الدراسية</p>
                </div>
            ...
            <div class="admin-page-card">
                <form action="{{ route('admin.schedules.update', $schedule->id) }}" method="POST" class="admin-form" id="schedule-edit-form">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="col-md-4">
                                    <div class="admin-form-field">
                                        ...
                                        <input type="number" name="order" class="form-control @error('order') is-invalid @enderror"
                                               value="{{ old('order', $schedule->order) }}" min="0">
                                ...
                                <div class="col-md-6">
                                    <div class="admin-form-field">
                                        ...
                                        <input type="text" name="room" class="form-control @error('room') is-invalid @enderror"
                                               value="{{ old('room', $schedule->room) }}" placeholder="مثال: قاعة 101">
                                ...
                                <div class="col-12">
                                    <div class="admin-form-field">
                                        ...
                                        <textarea name="notes" class="form-control @error('notes') is-invalid @enderror"
                                                  rows="3" placeholder="أي ملاحظات إضافية...">{{ old('notes', $schedule->notes) }}</textarea>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        if (window.AdminTables && AdminTables.initAdminForm) {
            AdminTables.initAdminForm(document.getElementById('schedule-edit-form'));
        }
    });
</script>
@endpush
