        ...
        <div class="container-fluid">
            ...
            <div class="admin-page-header">
                <div class="page-title-wrap">
                    ...
                    <p>تعريف مرحلة تعليمية جديدة في النظام</p>
                </div>
            ...
            <div class="admin-page-card">
                <form action="{{ route('admin.grades.store') }}" method="POST" class="admin-form" id="grade-create-form">
                    @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="admin-form-field">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                               name="name" value="{{ old('name') }}" placeholder="مثال: الابتدائي" required>
                                ...
                                <div class="col-md-6">
                                    <div class="admin-form-field">
                                        ...
                                        <input type="text" class="form-control @error('name_en') is-invalid @enderror"
                                               name="name_en" value="{{ old('name_en') }}" placeholder="Primary">
                                ...
                                <div class="col-12">
                                    <div class="admin-form-field">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror"
                                                  name="description" rows="3" placeholder="وصف اختياري للمرحلة">{{ old('description') }}</textarea>
                                ...
                                <div class="col-md-3">
                                    <div class="admin-form-field">
                                        ...
                                        <input type="number" class="form-control @error('min_age') is-invalid @enderror"
                                               name="min_age" value="{{ old('min_age') }}" min="0" placeholder="6">
                                ...
                                <div class="col-md-3">
                                    <div class="admin-form-field">
                                        ...
                                        <input type="number" class="form-control @error('max_age') is-invalid @enderror"
                                               name="max_age" value="{{ old('max_age') }}" min="0" placeholder="12">
                                ...
                                <div class="col-md-3">
                                    <div class="admin-form-field">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('fees') is-invalid @enderror"
                                               name="fees" value="{{ old('fees') }}" min="0" placeholder="5000">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        if (window.AdminTables && AdminTables.initAdminForm) {
            AdminTables.initAdminForm(document.getElementById('grade-create-form'));
        }
    });
</script>
@endpush
