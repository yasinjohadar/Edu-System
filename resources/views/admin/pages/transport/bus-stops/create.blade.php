...
@section('page-title') إضافة محطة @stop
@section('content')
<div class="main-content app-content"><div class="container-fluid">
@include('admin.partials.flash-alerts')
<div class="admin-page-header">
    <div class="page-title-wrap"><h1>إضافة محطة</h1></div>
    <a href="{{ route('admin.bus-stops.index') }}" class="admin-btn admin-btn-secondary"><i class="ri-arrow-right-line"></i> العودة</a>
</div>
<div class="admin-page-card">
<form action="{{ route('admin.bus-stops.store') }}" method="POST" class="admin-form" id="bus-stop-form">
@csrf
<div class="admin-form-body">@include('admin.pages.transport.bus-stops._form')</div>
