    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">إضافة محاضرة جديدة</h5>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.online-lectures.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="section_id" class="form-select" required>
                                            ...
                                            @foreach($sections as $section)
                                                <option value="{{ $section->id }}" {{ old('section_id') == $section->id ? 'selected' : '' }}>{{ $section->class->name }} - {{ $section->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('section_id')
                                            <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="type" class="form-select" required id="lecture_type">
                                            <option value="recorded" {{ old('type', 'recorded') == 'recorded' ? 'selected' : '' }}>مسجلة</option>
                                            <option value="live" {{ old('type') == 'live' ? 'selected' : '' }}>مباشرة</option>
                                            <option value="material" {{ old('type') == 'material' ? 'selected' : '' }}>مواد</option>
                                        </select>
                                        @error('type')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6 mb-3" id="video_url_div">
                                        ...
                                        <input type="url" name="video_url" class="form-control" value="{{ old('video_url') }}" placeholder="https://example.com/video">
                                        @error('video_url')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3" id="audio_url_div">
                                        ...
                                        <input type="url" name="audio_url" class="form-control" value="{{ old('audio_url') }}" placeholder="https://example.com/audio">
                                        @error('audio_url')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3" id="meeting_link_div" style="display: none;">
                                        ...
                                        <input type="url" name="meeting_link" class="form-control" value="{{ old('meeting_link') }}" placeholder="https://meet.example.com/...">
                                        @error('meeting_link')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
