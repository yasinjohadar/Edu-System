    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">تسجيل استعارة جديدة</h5>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.book-borrowings.store') }}" method="POST">
                                @csrf
                                
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">الكتاب <span class="text-danger">*</span></label>
                                        <select name="book_id" class="form-select" required id="book_id">
                                            <option value="">اختر الكتاب</option>
                                            @foreach($books as $book)
                                                <option value="{{ $book->id }}" data-available="{{ $book->available_copies }}" {{ old('book_id') == $book->id ? 'selected' : '' }}>
                                                    {{ $book->title }} (متاح: {{ $book->available_copies }})
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('book_id')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">تاريخ الاستعارة <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <small class="text-muted">المدة الافتراضية: 14 يوم</small>
                                        @error('due_date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
