    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">تعديل كتاب</h5>
                </div>
            </div>
                            ...
                            <form action="{{ route('admin.books.update', $book->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="publication_year" class="form-control" min="1000" max="{{ date('Y') }}" value="{{ old('publication_year', $book->publication_year) }}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="language" class="form-select">
                                            <option value="ar" {{ old('language', $book->language) == 'ar' ? 'selected' : '' }}>عربي</option>
                                            <option value="en" {{ old('language', $book->language) == 'en' ? 'selected' : '' }}>إنجليزي</option>
                                        </select>
                                        @error('language')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <small class="text-muted">النسخ المتاحة حالياً: {{ $book->available_copies }}</small>
                                        @error('total_copies')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="price" class="form-control" step="0.01" min="0" value="{{ old('price', $book->price) }}">
                                        @error('price')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="location" class="form-control" value="{{ old('location', $book->location) }}" placeholder="مثال: رف A-3">
                                        @error('location')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @if($book->cover_image)
                                            <div class="mb-2">
                                                <img src="{{ asset('storage/' . $book->cover_image) }}" alt="{{ $book->title }}" class="img-thumbnail" style="max-width: 150px;">
                                            </div>
                                        @endif
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="is_active" value="1" {{ old('is_active', $book->is_active) ? 'checked' : '' }}>
