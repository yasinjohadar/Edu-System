    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">إضافة مادة جديدة</h5>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="weekly_hours" value="{{ old('weekly_hours', 0) }}" min="0">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">الدرجة الكاملة</label>
                                            <input type="number" step="0.01" class="form-control" name="full_marks" value="{{ old('full_marks', 100) }}" min="0">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">درجة النجاح</label>
                                            <input type="number" step="0.01" class="form-control" name="pass_marks" value="{{ old('pass_marks', 50) }}" min="0">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="classes[]" multiple>
                                                @foreach($classes as $class)
                                                    <option value="{{ $class->id }}" {{ in_array($class->id, old('classes', [])) ? 'selected' : '' }}>{{ $class->grade->name }} - {{ $class->name }}</option>
                                                @endforeach
                                            </select>
