        ...
        <div class="container-fluid">
            ...
            <div class="admin-page-header">
                <div class="page-title-wrap">
                    <h1>تعديل المعلم: {{ $teacher->user->name }}</h1>
                    <p>تحديث بيانات المعلم</p>
                </div>
            ...
            <div class="admin-page-card">
                <form action="{{ route('admin.teachers.update', $teacher->id) }}" method="POST" enctype="multipart/form-data" class="admin-form" id="teacher-edit-form">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="col-md-6">
                                    <div class="admin-form-field">
                                        ...
                                        <input type="text" class="form-control @error('teacher_code') is-invalid @enderror"
                                               name="teacher_code" value="{{ old('teacher_code', $teacher->teacher_code) }}" required>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="admin-form-field">
                                        ...
                                        <input type="date" class="form-control @error('date_of_birth') is-invalid @enderror"
                                               name="date_of_birth" value="{{ old('date_of_birth', $teacher->date_of_birth?->format('Y-m-d')) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="admin-form-field">
                                        ...
                                        <input type="date" class="form-control @error('hire_date') is-invalid @enderror"
                                               name="hire_date" value="{{ old('hire_date', $teacher->hire_date?->format('Y-m-d')) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="admin-form-field">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('salary') is-invalid @enderror"
                                               name="salary" value="{{ old('salary', $teacher->salary) }}" min="0">
                                    ...
                                    <div class="admin-form-field">
                                        ...
                                        <select class="form-select @error('subjects') is-invalid @enderror" name="subjects[]" data-admin-choices multiple>
                                            @foreach ($subjects as $subject)
                                                <option value="{{ $subject->id }}" {{ in_array($subject->id, old('subjects', $teacher->subjects->pluck('id')->toArray())) ? 'selected' : '' }}>
                                                    {{ $subject->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-12">
                                    <div class="admin-form-field">
                                        ...
                                        @if ($teacher->photo)
                                            <div class="mb-2">
                                                <img src="{{ asset('storage/' . $teacher->photo) }}" alt="{{ $teacher->user->name }}" style="max-width: 100px; max-height: 100px; border-radius: 8px;">
                                            </div>
                                        @endif
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        if (window.AdminTables && AdminTables.initAdminForm) {
            AdminTables.initAdminForm(document.getElementById('teacher-edit-form'));
        }
    });
</script>
@endpush
