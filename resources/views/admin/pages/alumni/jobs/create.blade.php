...
@section('page-title') إضافة وظيفة @stop
@section('content')
<div class="main-content app-content"><div class="container-fluid">
@include('admin.partials.flash-alerts')
<div class="admin-page-header">
    <div class="page-title-wrap"><h1>إضافة وظيفة</h1></div>
    <a href="{{ route('admin.job-postings.index') }}" class="admin-btn admin-btn-secondary"><i class="ri-arrow-right-line"></i> العودة</a>
</div>
<div class="admin-page-card">
<form action="{{ route('admin.job-postings.store') }}" method="POST" class="admin-form" id="job-form">@csrf
<div class="admin-form-body">@include('admin.pages.alumni.jobs._form', ['employmentTypes' => $employmentTypes])</div>
