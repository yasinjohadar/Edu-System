    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">تعديل حضور</h5>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.lecture-attendance.update', $attendance->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="lecture_id" class="form-select" required>
                                            ...
                                            @foreach($lectures as $lecture)
                                                <option value="{{ $lecture->id }}" {{ old('lecture_id', $attendance->lecture_id) == $lecture->id ? 'selected' : '' }}>{{ $lecture->title }}</option>
                                            @endforeach
                                        </select>
                                        @error('lecture_id')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="status" class="form-select" required>
                                            ...
                                            <option value="excused" {{ old('status', $attendance->status) == 'excused' ? 'selected' : '' }}>معذور</option>
                                        </select>
                                        @error('status')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="datetime-local" name="joined_at" class="form-control" value="{{ old('joined_at', $attendance->joined_at ? $attendance->joined_at->format('Y-m-d\TH:i') : '') }}">
                                        @error('joined_at')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="datetime-local" name="left_at" class="form-control" value="{{ old('left_at', $attendance->left_at ? $attendance->left_at->format('Y-m-d\TH:i') : '') }}">
                                        @error('left_at')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="duration_minutes" class="form-control" min="0" value="{{ old('duration_minutes', $attendance->duration_minutes) }}">
