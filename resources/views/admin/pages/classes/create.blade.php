        ...
        <div class="container-fluid">
            ...
            <div class="admin-page-header">
                <div class="page-title-wrap">
                    <h1>إضافة صف جديد</h1>
                    <p>تعريف صف دراسي وربطه بمرحلة تعليمية</p>
                </div>
            ...
            <div class="admin-page-card">
                <form action="{{ route('admin.classes.store') }}" method="POST" class="admin-form" id="class-create-form">
                    @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="admin-form-field">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                               name="name" value="{{ old('name') }}" placeholder="مثال: الأول" required>
                                ...
                                <div class="col-md-6">
                                    <div class="admin-form-field">
                                        ...
                                        <input type="text" class="form-control @error('name_en') is-invalid @enderror"
                                               name="name_en" value="{{ old('name_en') }}" placeholder="Grade 1">
                                ...
                                <div class="col-12">
                                    <div class="admin-form-field">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror"
                                                  name="description" rows="3" placeholder="وصف اختياري للصف">{{ old('description') }}</textarea>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        if (window.AdminTables && AdminTables.initAdminForm) {
            AdminTables.initAdminForm(document.getElementById('class-create-form'));
        }
    });
</script>
@endpush
