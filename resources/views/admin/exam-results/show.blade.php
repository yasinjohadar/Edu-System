...
@section('title', 'عرض نتيجة الاختبار')

@section('content')
<div class="page-header">
    <h1 class="page-title">عرض نتيجة الاختبار</h1>
    <div class="page-subtitle">تفاصيل نتيجة الطالب في الاختبار</div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>المرحلة:</th>
                        <td>{{ $result->student->grade->name ?? '-' }}</td>
                    </tr>
                    <tr>
                        <th>القسم:</th>
            ...
            <div class="answer-item mb-4 p-4 border rounded">
                ...
                <div class="answer-details">
                    ...
                    @if($answer->question->type == 'multiple_choice')
                        ...
                        @if($result->exam->show_answers || auth()->user()->hasRole('admin'))
...
<!-- أزرار الإجراءات -->
<div class="mt-4">
    <a href="{{ route('admin.exam-results.edit', $result) }}" class="btn btn-warning">
