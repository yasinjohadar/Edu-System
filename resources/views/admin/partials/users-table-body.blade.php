@forelse ($users as $user)
    ...
    <tr>
        ...
        <td>
            <strong class="admin-user-link d-block">{{ $user->name }}</strong>
        </td>
        <td>
            @if ($user->email)
        ...
        <td>
            <div class="admin-action-group">
                @can('user-show')
                    <a href="{{ route('users.show', $user->id) }}" class="admin-action-btn admin-action-view" title="عرض">
                        <i class="ri-eye-line"></i>
                    </a>
                @endcan
                @can('user-edit')
                    <a href="{{ route('users.edit', $user->id) }}" class="admin-action-btn admin-action-edit" title="تعديل">
