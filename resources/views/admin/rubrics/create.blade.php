...
@section('title', 'إضافة معيار تقييم جديد')

@section('content')
<div class="page-header">
    <h1 class="page-title">إضافة معيار تقييم جديد</h1>
    <div class="page-subtitle">إنشاء معيار تقييم للأسئلة المقالية</div>
</div>

<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.rubrics.store') }}" method="POST" id="rubricForm">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" name="total_points" class="form-control" required min="0" step="0.5">
            </div>
