    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div>
                    <h4 class="mb-0">تعديل إعدادات SMTP: {{ $smtpSetting->name }}</h4>
                    <p class="mb-0 text-muted">تعديل إعدادات خادم البريد الإلكتروني</p>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="smtpForm" action="{{ route('admin.smtp-settings.update', $smtpSetting->id) }}" method="POST" class="form-horizontal">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="encryption" id="encryption" class="form-control" required>
                                                ...
                                                <option value="none" {{ old('encryption', $smtpSetting->encryption) == 'none' ? 'selected' : '' }}>بدون تشفير</option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox checkbox-primary">
                                                <input type="checkbox" 
                                                       ...
                                                       id="is_default" 
                                                       value="1"
                                                       {{ $smtpSetting->is_default ? 'checked' : '' }}>
...
function testConnection() {
    ...
    if (!data.host || !data.port || !data.username || !data.from_address || !data.from_name) {
